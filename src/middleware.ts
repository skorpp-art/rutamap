...
const RUTAS_PROTEGIDAS = ["/admin", "/bienvenida", "/mapa", "/carga", "/volumenes", "/analisis-diario", "/pendientes", "/alternativas", "/casos", "/deposito", "/ruta", "/usuarios", "/descargar"];
