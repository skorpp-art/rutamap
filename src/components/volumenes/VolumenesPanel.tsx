...
export function VolumenesPanel() {
  const [tab, setTab] = useState<"dashboard" | "proyeccion" | "planificacion" | "operacion" | "analisis" | "historial" | "plantillas" | "kpis">("proyeccion");
  ...
  return (
    <div className="flex flex-col h-full bg-background">
      ...
      <div className="border-b px-3 sm:px-6 flex gap-1 overflow-x-auto no-scrollbar">
        {([["proyeccion", "1 · Proyección"], ["planificacion", "2 · Planificación"], ["operacion", "3 · Operación del Día"], ["plantillas", "🗓 Plantillas"], ["kpis", "📈 Monitoreo"], ["analisis", "📊 Análisis"], ["dashboard", "Dashboard"], ["historial", "Historial"]] as const).map(([t, lbl]) => (
