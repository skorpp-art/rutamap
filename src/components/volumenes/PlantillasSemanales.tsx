...
export function PlantillasSemanales({ onUsarValor }: Props) {
  ...
  return (
    <div className="p-5 space-y-4">
      ...
      {/* Aviso % manual */}
      <div className="flex items-start gap-2 text-xs text-amber-700 dark:text-amber-300 bg-amber-50 dark:bg-amber-950/30 border border-amber-200 dark:border-amber-900 rounded-lg px-3 py-2">
              ...
              <tr key={sem.n} className="border-b last:border-0 hover:bg-accent/10">
                ...
                <td className="px-3 py-2 sticky left-0 bg-background">
                  ...
                  <div className="flex items-center gap-1.5 mt-0.5">
                    <span className="text-xs text-muted-foreground">{sem.sub}</span>
                    <div className="flex items-center gap-0.5">
                      <input
                        ...
                        className={cn(
                          "w-12 text-xs font-bold px-1 py-px rounded border text-center tabular-nums",
                  ...
                  return (
                    <td key={d} className="px-1.5 py-1.5 text-center align-top">
                      ...
                      <button
                        ...
                        className={cn(
                          "mt-1 block mx-auto text-xs tabular-nums transition-colors",
                      ...
                      {val > 0 && onUsarValor && (
                        <button
                          ...
                          className="mt-0.5 mx-auto flex items-center gap-0.5 text-xs text-emerald-600 dark:text-emerald-300 hover:text-emerald-700 font-medium"
                        >
